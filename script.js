function nama(){
    if(document.getElementById('usernama').value != 'fauzan'){
...
function pass(){
    if(document.getElementById('password').value != 'aku'){
...
function submit() {
    var username = document.getElementById('usernama').value
    var password = document.getElementById('password').value

    if(username == 'fauzan' && password == 'aku'){
        Swal.fire({
            type: 'success',
